...
<div style="margin: 20px" class="splash_main">
	...
	<p>
		...
		Find project code in GitHub: <a href="https://github.com/outbrain/propagator">https://github.com/outbrain/propagator</a>
	</p>
	<p>
	...
	<h6>Not sure what to do next?</h6>
	<p>
		Why don't you <a href="index.php?action=input_script"><strong>propagate a script</strong></a>?
	</p>
	</div>
